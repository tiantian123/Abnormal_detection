...
train :
  ...
  def train(self, gradient_dataset, cg_dataset, initial_lambda=0.8, mu=0.01, global_backtracking=False, preconditioner=False, max_cg_iterations=250, num_updates=100, validation=None, validation_frequency=1, patience=numpy.inf, save_progress=None):
