...
if __name__ == "__main__"    :
    f1=file("D:/CV/Image_Decriptions/UCSD/ped2/error_total.csv","r")
    d = np.loadtxt(f1, delimiter=',')
    f1.close()
    f2=file("D:/CV/Image_Decriptions/UCSD/ped2/ped2_locate.csv","r")
    ...
    for idx in xrange(0,30):
        ...
        for i in range(0,1800):     
            for j in range (0,50):
                #feature[i,j]=sum(d[i,j*24:j*24+8]*0.6) +sum(d[i,j*24+8:j*24+16]*2)+ sum(d[i,j*24+16:j*24+24]*3.4)
